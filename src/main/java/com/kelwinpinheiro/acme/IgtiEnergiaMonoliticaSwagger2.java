package com.kelwinpinheiro.acme;
...
@EnableSwagger2
public class IgtiEnergiaMonoliticaSwagger2 {

    public static void main(String[] args) {
        ApplicationContext ctx = SpringApplication.run(IgtiEnergiaMonoliticaSwagger2.class, args);
    }
